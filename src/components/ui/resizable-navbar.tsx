...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-[60] mx-auto hidden w-full max-w-7xl flex-row items-center self-start rounded-full bg-white border-2 border-orange-500 lg:flex shadow-lg",
...
export const MobileNav = ({ children, className, visible }: MobileNavProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-50 mx-auto flex w-full max-w-[calc(100vw-2rem)] flex-col items-center justify-between bg-white border-2 border-orange-500 px-0 py-2 lg:hidden shadow-lg",
        className,
      )}
    >
      {children}
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          exit={{ opacity: 0 }}
          className={cn(
            "absolute inset-x-0 top-16 z-50 flex w-full flex-col items-start justify-start gap-4 rounded-lg bg-white border-2 border-orange-500 px-4 py-8 shadow-lg",
            className,
          )}
        >
          {children}
...
export const NavbarLogo = () => {
  return (
    ...
    >
      ...
      />
      <span className="font-medium text-black dark:text-white">FuturCraft Institut</span>
    </a>
  );
};
