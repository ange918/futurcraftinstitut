...
export const defaultTestimonials = [
    {
        src: '/image/ange.jpg',
        name: 'Ange Ndiaye',
        designation: 'Étudiante en Développement Web',
    ...
    },
    {
        ...
        name: 'Victoire Kouassi',
        designation: 'Développeuse Mobile',
    ...
    },
    {
        ...
        quote: 'Les outils et technologies enseignés sont à la pointe. J’ai pu me spécialiser en intelligence artificielle et décrocher un stage dans une grande entreprise.',
    },
    {
        src: '/image/pro1.jpg',
        name: 'Richy Hermann',
        designation: 'Formateur en développement web',
...
export const AnimatedTestimonials = ({
    ...
    return (
        <>
            <h2 className="text-3xl font-bold text-[#ff9900] text-center mb-10">
                Témoignages
            </h2>
            <div className="mx-auto max-w-sm px-4 py-20 font-sans antialiased md:max-w-4xl md:px-8 lg:px-12 border-2 border-[#ff9900] rounded-3xl bg-[#181818]">
                <div className="relative grid grid-cols-1 gap-20 md:grid-cols-2">
                    ...
                    <div className="flex flex-col justify-between py-4">
                        <motion.div
                            ...
                            <h3 className="text-2xl font-bold text-[#ff9900]">
