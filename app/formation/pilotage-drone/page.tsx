...
export default function PilotageDronePage() {
    ...
    return (
        <div className="min-h-screen bg-background pt-24 font-sans">
            {/* Header avec sous-menu Formations */}
            <header className="w-full max-w-7xl mx-auto flex items-center justify-between py-6 px-4 md:px-8">
                <div className="flex items-center gap-4">
                    ...
                    <nav className="hidden md:flex gap-8 text-white font-medium">
                        ...
                        <div className="relative group">
                            ...
                            <div className="absolute left-0 top-full mt-2 w-64 bg-white text-foreground rounded-xl shadow-lg opacity-0 group-hover:opacity-100 pointer-events-none group-hover:pointer-events-auto transition-opacity z-20">
                ...
                <a
                    href="#admissions"
                    className="bg-secondary text-white px-6 py-2 rounded-full font-bold shadow-lg hover:bg-yellow-400 transition">
                    Admissions
                </a>
            </header>
            {/* Hero Section - Pilotage de drone */}
                ...
                <div className="container mx-auto max-w-6xl flex flex-col md:flex-row items-center justify-between gap-12">
                    ...
                    <div className="flex-1 text-left">
                        ...
                        <p className="text-lg text-muted-foreground mb-8 max-w-lg">
                            Apprends à piloter des drones professionnels, à
                            réaliser des prises de vue aériennes et à exploiter
                            les données pour des applications innovantes.
                        </p>
                ...
                <div className="container mx-auto max-w-6xl flex flex-col lg:flex-row gap-12 items-start">
                    <div className="flex-1">
                        ...
                        <p className="text-lg text-foreground/90 mb-2">
                            ...
                            devenir un professionnel du pilotage de drones, de
                            la captation d'images aériennes et de l'analyse de
                            données pour l'agriculture, la sécurité,
                            l'audiovisuel ou la cartographie.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="container mx-auto max-w-6xl relative z-10 flex flex-col md:flex-row items-center justify-between gap-16">
                    <div className="flex-1 bg-[#0a0a1a] rounded-2xl p-10 relative shadow-xl">
                        ...
                        <p className="text-lg text-white/90">
                            ...
                            pilote de drone, opérateur de prises de vue
                            aériennes, technicien de données ou chef de projet
                            drone.
                        </p>
                    </div>
                        ...
                        <div className="flex flex-col md:flex-row gap-8 items-stretch justify-center">
                            ...
                            <div className="flex-1 bg-[#181a20] rounded-2xl p-8 shadow-lg relative flex flex-col">
                                ...
                                <div className="text-white/80 mt-2">
                                    ...
                                    compétences de base en pilotage ou prise de
                                    vue.
                                </div>
                            </div>
                            <div className="hidden md:flex items-center justify-center">
