...
export default function WebmasterPage() {
    ...
    // Liste des 13 formations pour le sous-menu
    const formations = [
        {
                ...
                <div className="container mx-auto max-w-6xl flex flex-col md:flex-row items-center justify-between gap-12">
                    ...
                    <div className="flex-1 text-left">
                        ...
                        <p className="text-lg text-muted-foreground mb-8 max-w-lg">
                            Une formation complète pour devenir Webmaster, gérer
                            et maintenir des sites web professionnels, maîtriser
                            les outils de gestion de contenu et assurer la
                            présence en ligne d'une organisation.
                        </p>
                ...
                <div className="container mx-auto max-w-6xl flex flex-col lg:flex-row gap-12 items-start">
                    <div className="flex-1">
                        ...
                        <div className="flex flex-wrap gap-3 mb-6">
                            ...
                            <span className="px-5 py-2 rounded-full border border-muted-foreground text-muted-foreground text-base font-medium bg-background">
                            CMS & Gestion de contenu Webmastering
                            </span>
                        </div>
                        <p className="text-lg text-foreground/90 mb-2">
                            Cette formation est faite pour toi si tu veux
                            devenir le garant technique et éditorial d'un site
                            web, savoir gérer l'intégralité d'un site, de la
                            mise en ligne à la maintenance, en passant par
                            l'optimisation SEO et la gestion de contenu. Tu
                            apprendras à utiliser les principaux CMS, à assurer
                            la sécurité et la performance d'un site, et à
                            collaborer avec des équipes de développeurs,
                ...
                <div className="container mx-auto max-w-6xl relative z-10 flex flex-col md:flex-row items-center justify-between gap-16">
                    <div className="flex-1 bg-[#0a0a1a] rounded-2xl p-10 relative shadow-xl">
                        ...
                        <p className="text-lg text-white/90">
                            Le titre de Webmaster délivré par FuturCraft
                            Institut permet d'accéder à des postes de gestion de
                            sites web, de support technique, ou de responsable
                            de la présence en ligne d'une organisation.
                        </p>
                    </div>
                    <div className="flex-1 flex items-center justify-center">
                        <img
                        ...
                        <div className="flex flex-col md:flex-row gap-8 items-stretch justify-center">
                            ...
                            <div className="flex-1 bg-[#181a20] rounded-2xl p-8 shadow-lg relative flex flex-col">
                                ...
                                <div className="text-white/80 mt-2">
                                    ...
                                    compétences de base en gestion de site web.
                                </div>
                            </div>
                            {/* Flèche */}
                            <div className="hidden md:flex items-center justify-center">
            ...
            <section className="bg-[#0a0a1a] py-24 px-4">
                <div className="container mx-auto max-w-5xl">
                    ...
                    <div className="flex flex-col gap-4">
                        {[
                            'Quels sont les prérequis pour devenir Webmaster ?',
